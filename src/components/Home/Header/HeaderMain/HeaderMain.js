    ...
    return (
        <div className="row header-main-focus-container">
            <div className="col-md-8">
                <h1 style={{fontWeight: '700'}} className="text-white  header-main-focus-text">Excellent Services For Repairing Your <span style={{fontSize: '1.4em', color: '#fd374e'}}>Broken Gadget</span></h1>
